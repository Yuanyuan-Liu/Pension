package com.circle.pension.common.interceptor;
...
public class LogInterceptor {
     ...
     * 定义包切点：controller层
     */
    @Pointcut("execution(* com.circle.pension.controller.*.*(..))")
...
/*    @Around("controller()")
    ...
    public JoinPoint afterReturning(JoinPoint joinPoint, Object returnValue) {
        ...
        log.info("计时结束：{}  耗时：{}  URI: {}  最大内存: {}m  已分配内存: {}m  已分配内存中的剩余空间: {}m  最大可用内存: {}m",
                new SimpleDateFormat("hh:mm:ss.SSS").format(endTimeMillis), (endTimeMillis - startTimeMillis),
