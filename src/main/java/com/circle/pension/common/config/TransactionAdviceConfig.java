package com.circle.pension.common.config;
...
public class TransactionAdviceConfig {
    ...
    /*定义切点变量：拦截com.licf.demo.service包下所有类的所有方法,返回值类型任意的方法*/
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.licf.demo.service..*(..))";
